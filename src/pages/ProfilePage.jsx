...
export const ProfilePage = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    if (updateUser.fulfilled.match(resultAction)) {
      dispatch(addToast({ message: 'Profil bilgileri güncellendi.', type: 'success' }));
  ...
  const handlePasswordChange = (e) => {
    ...
    if (!passwords.oldPassword || !passwords.newPassword || !passwords.confirmPassword) {
      dispatch(addToast({ message: 'Lütfen tüm şifre alanlarını doldurun.', type: 'warning' }));
      return;
    }
    if (passwords.newPassword !== passwords.confirmPassword) {
      dispatch(addToast({ message: 'Yeni şifreler eşleşmiyor.', type: 'error' }));
      return;
    }
  ...
  const handleLanguageChange = (newLang) => {
    ...
    dispatch(addToast({ message: newLang === 'tr' ? 'Dil Türkçe olarak ayarlandı.' : 'Language set to English.', type: 'success' }));
  };

  return (
    <div className="space-y-lg max-w-4xl text-left">
      <div className="space-y-xs">
        <h1 className="font-display-lg text-primary text-3xl font-bold">Profil & Ayarlar</h1>
        <p className="font-body-md text-on-surface-variant">Hesap bilgilerinizi, şifrenizi ve sistem tercihlerini buradan yönetin.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-lg">
        {/* Profile Info Form */}
        <section className="glass-card p-lg rounded-xl border border-outline-variant space-y-md">
          <h2 className="font-headline-h2 text-xl font-bold text-on-surface border-l-4 border-ember-orange pl-sm">Profil Bilgileri</h2>
          <form onSubmit={handleUpdateProfile} className="space-y-md">
            ...
            <div>
              <label className="block text-xs font-semibold text-on-surface-variant mb-1 uppercase">E-posta</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-xs font-semibold text-on-surface-variant mb-1 uppercase">Telefon</label>
              <input
                type="text"
                className="w-full px-3 py-2 border border-outline bg-surface-container text-on-surface rounded-lg focus:outline-none focus:ring-vivid-purple focus:border-vivid-purple sm:text-sm font-metadata-mono"
                value={phone}
        ...
        <section className="glass-card p-lg rounded-xl border border-outline-variant space-y-md">
          <h2 className="font-headline-h2 text-xl font-bold text-on-surface border-l-4 border-ember-orange pl-sm">Şifre Değiştir</h2>
          <form onSubmit={handlePasswordChange} className="space-y-md">
            <div>
              <label className="block text-xs font-semibold text-on-surface-variant mb-1 uppercase">Mevcut Şifre</label>
              <input
                type="password"
                className="w-full px-3 py-2 border border-outline bg-surface-container text-on-surface rounded-lg focus:outline-none focus:ring-vivid-purple focus:border-vivid-purple sm:text-sm font-metadata-mono"
            ...
            <div>
              <label className="block text-xs font-semibold text-on-surface-variant mb-1 uppercase">Yeni Şifre</label>
              <input
                type="password"
                className="w-full px-3 py-2 border border-outline bg-surface-container text-on-surface rounded-lg focus:outline-none focus:ring-vivid-purple focus:border-vivid-purple sm:text-sm font-metadata-mono"
            ...
            <div>
              <label className="block text-xs font-semibold text-on-surface-variant mb-1 uppercase">Yeni Şifre (Tekrar)</label>
              <input
                type="password"
                className="w-full px-3 py-2 border border-outline bg-surface-container text-on-surface rounded-lg focus:outline-none focus:ring-vivid-purple focus:border-vivid-purple sm:text-sm font-metadata-mono"
        ...
        <section className="glass-card p-lg rounded-xl border border-outline-variant space-y-md">
          <h2 className="font-headline-h2 text-xl font-bold text-on-surface border-l-4 border-ember-orange pl-sm">Bildirim Tercihleri</h2>
          <div className="space-y-sm font-body-md text-sm">
            <p className="text-on-surface-variant text-xs pb-xs">Kütüphane duyuruları, kitap iade uyarıları ve rezervasyon bildirimlerini alacağınız kanallar:</p>
            
            <div className="flex justify-between items-center py-sm border-b border-outline-variant/30">
              <div>
                <p className="text-on-surface font-semibold">SMS Bildirimleri</p>
                <p className="text-xs text-on-surface-variant">Telefon numarasına SMS gönderilir.</p>
              </div>
              <button 
                type="button"
              ...
              >
                <div className={`bg-white w-4 h-4 rounded-full shadow-md transition-transform duration-300 ${notifPrefs.sms ? 'translate-x-6' : 'translate-x-0'}`}></div>
              </button>
            </div>

            <div className="flex justify-between items-center py-sm border-b border-outline-variant/30">
              <div>
                <p className="text-on-surface font-semibold">E-posta Bildirimleri</p>
                <p className="text-xs text-on-surface-variant">E-posta adresinize bülten ve hatırlatmalar gönderilir.</p>
              </div>
              <button 
                type="button"
              ...
              >
                <div className={`bg-white w-4 h-4 rounded-full shadow-md transition-transform duration-300 ${notifPrefs.email ? 'translate-x-6' : 'translate-x-0'}`}></div>
              </button>
            </div>

            <div className="flex justify-between items-center py-sm">
              <div>
                <p className="text-on-surface font-semibold">Push Bildirimleri</p>
                <p className="text-xs text-on-surface-variant">Tarayıcı veya uygulama içi anlık bildirimler.</p>
              </div>
              <button 
                type="button"
              ...
              >
                <div className={`bg-white w-4 h-4 rounded-full shadow-md transition-transform duration-300 ${notifPrefs.push ? 'translate-x-6' : 'translate-x-0'}`}></div>
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="glass-card p-lg rounded-xl border border-outline-variant space-y-md">
          <h2 className="font-headline-h2 text-xl font-bold text-on-surface border-l-4 border-ember-orange pl-sm">Sistem Tercihleri</h2>
          <div className="space-y-md font-body-md text-sm">
            ...
            <div className="flex justify-between items-center py-xs border-b border-outline-variant/30">
              <div>
                ...
                <p className="text-xs text-on-surface-variant">Midnight (Karanlık) / Day (Aydınlık) modu.</p>
              </div>
              <button
                type="button"
            ...
            <div className="flex justify-between items-center py-xs">
              <div>
                <p className="text-on-surface font-semibold">Sistem Dili</p>
                <p className="text-xs text-on-surface-variant">Uygulama arayüz metin dili.</p>
              </div>
              <select
                value={lang}
                onChange={(e) => handleLanguageChange(e.target.value)}
                className="bg-surface-container border border-outline-variant/50 text-on-surface rounded-lg px-2 py-1.5 text-xs focus:outline-none font-bold"
              >
