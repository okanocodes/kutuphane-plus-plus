...
export const Modal = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full z-50 flex items-center justify-center p-md">
      ...
      {/* Modal Container */}
      <div className="relative w-[500px] max-w-full shrink-0 glass-card border border-outline-variant p-lg rounded-2xl shadow-glow-accent z-10 space-y-md">
        <div className="flex justify-between items-center border-b border-outline-variant pb-sm">
          <h3 className="font-headline-h3 text-xl font-bold text-on-surface">{title}</h3>
          <button 
            onClick={onClose} 
