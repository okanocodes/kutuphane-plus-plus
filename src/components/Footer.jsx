        ...
        <footer className="bg-surface-container-highest dark:bg-surface-container-highest w-full relative bottom-0">
            <div className="flex flex-col md:flex-row justify-between items-center px-margin-desktop py-lg w-full max-w-7xl mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-lg">
                    <a className="font-label-xs text-label-xs text-on-surface-variant hover:text-ember-orange underline transition-all opacity-80 hover:opacity-100" href="#">Hakkımızda</a>
                    <a className="font-label-xs text-label-xs text-on-surface-variant hover:text-ember-orange underline transition-all opacity-80 hover:opacity-100" href="#">Kullanım Koşulları</a>
                    <a className="font-label-xs text-label-xs text-on-surface-variant hover:text-ember-orange underline transition-all opacity-80 hover:opacity-100" href="#">Gizlilik Politikası</a>
                    <a className="font-label-xs text-label-xs text-on-surface-variant hover:text-ember-orange underline transition-all opacity-80 hover:opacity-100" href="#">İletişim</a>
                </div>
