...
- Sen bir Reactjs uzmanısın. 
- Projeyi  benim belirlediğim kurallar ve şablon doğrultusunda sıfırdan oluşturacaksın. 


## Performance & State Guardrails
* **Hook Dependency Arrays**: Always include exhaustive dependencies in `useEffect`, `useMemo`, and `useCallback`.
* **State Localization**: Keep state as close to the relevant component as possible. Do not lift state globally unless shared by 3+ views.
